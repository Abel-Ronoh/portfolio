...
export default function Home() {
  return (
    ...
    <p className=" tracking-wider  w-[35rem]">I have 1 Year of experience developing functional full stack applications with <span className=" tracking-wider font-normal text-custom-textcolor2">REACT JS, NEXT JS, NODE JS, FIREBASE & MONGODB</span>  </p>
    <div className="flex justify-between items-center">
    <button className=" hover:bg-custom-textcolor  hover:text-custom-blue yatra text-lg text-custom-lightblue rounded-md  my-10 px-5  py-1 tracking-widest font-thin border-l border-r">See my work</button>
    <div className="flex">
    ...
    <h1 className="font-black text-custom-textcolor tracking-widest text-xl">Experiences</h1>
      <p className="font-thin text-xs hover:border-b p-0 cursor-pointer hover:text-custom-lightblue">View All </p>
      </div>
      <div className="flex justify-between mb-2">
      <a href="#"><p className="text-custom-lightblue">Hackathon at Davis & Shirtliff, Nairobi</p></a>
