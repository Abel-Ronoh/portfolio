...
export default function Home() {
  return (
    ...
    <h1 className="yatra  text-custom-lightblue text-6xl lg:text-7xl lg:mx-20 mx-5 font-bold">Im Abel-Rono<span className="text-custom-textcolor animate__animated animate__flash animate__infinite animate__slower">h</span></h1>
